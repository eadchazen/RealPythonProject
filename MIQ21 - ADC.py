...
df_1 = df_1[(df_1.sensor_id < 15.1)] #could use equal sign instead
df_2 = df_2[(df_2.sensor_id < 15.1)]
df_3 = df_3[(df_3.sensor_id < 15.1)]
...
df_1['sensor_id'] = 1 #change to "run" instead of sensor_id
df_2['sensor_id'] = 2
df_3['sensor_id'] = 3
